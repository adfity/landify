...
<div class="card shadow-sm border-0">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center">
            <a href="/setting/index" 
               style="display: flex; align-items: center; gap: 8px; text-decoration: none; padding-left: 24px;  color: black;">
                All help topics
        ...
        <li>
            <a href="#" 
               style="display: flex; align-items: center; gap: 8px; text-decoration: none; margin-right: 12px; color: black;">
                Getting Started
            </a>
        </li>
    </ol>
    ...
    <ul class="list-group" id="articleList">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <span style="margin-right: auto;">How to begin</span>
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
            <img src="{{ asset('images/managing.png') }}" style="width: 20px; height: 20px; margin-right: 10px;">
            <span style="margin-right: auto;">Choosing a template</span>
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
            <img src="{{ asset('images/managing.png') }}" style="width: 20px; height: 20px; margin-right: 10px;">
            <span style="margin-right: auto;">hiring a professional to build your site</span>
