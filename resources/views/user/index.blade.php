...
<script>
    document.getElementById('lastModifiedDropdown').addEventListener('click', () => {
    ...
    item.addEventListener('click', (event) => {
        ...
        console.log('Selected time range:', selectedTime);
        // Tambahkan logika Anda untuk filter berdasarkan waktu
    });
});


function filterPagesByTime(timeRange) {
    const pages = document.querySelectorAll('.page-item'); // Semua elemen halaman
    pages.forEach(page => {
        // Tambahkan logika validasi waktu berdasarkan data atribut
        // Misalnya data-date pada elemen page-item
        const pageDate = new Date(page.getAttribute('data-date'));
        if (timeRange === 'Today' && isToday(pageDate)) {
            page.style.display = 'block';
        } else if (timeRange === 'This Week' && isThisWeek(pageDate)) {
            page.style.display = 'block';
        } else if (timeRange === 'This Month' && isThisMonth(pageDate)) {
            page.style.display = 'block';
        } else {
