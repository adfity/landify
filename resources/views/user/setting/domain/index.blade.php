...
<!-- Content -->
<div class="content">
    <h4 class="mb-4">Current Domain</h4>
    <ol class="breadcrumb">
  ...
  <a href="/index" style="display: flex; align-items: center; gap: 8px; text-decoration: none; margin-right: 12px; color: black;">
    ...
    <hr class="custom-divider">
        <div class="card p-4">
            <div class="mb-3">
                <label for="current-domain" class="form-label fw-bold">Current Domain</label>
                <input type="text" class="form-control" id="current-domain" value="hskiby.landify.com" readonly>
                <small class="text-muted">This is the default subdomain provided by us. You can replace it with a custom domain anytime.</small>
                <hr class="custom-divider mt-3">
            </div>
            <div class="mb-3">
                <label for="custom-domain" class="form-label fw-bold">Connect a Custom Domain</label>
                <div class="input-group">
                    <input type="text" class="form-control" id="custom-domain" placeholder="landify">
                    <span class="input-group-text">.com</span>
                </div>
                <small class="text-success">Landify Domain is available</small>
            </div>
            <button class="btn btn-connect w-100 mb-3">Connect</button>
            <div class="mb-3">
                <label class="form-label fw-bold">Here are more great suggestions for you:</label>
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        landify.com
                        <span class="badge bg-success">Connected</span>
                    </li>
                    <li class="list-group-item">landify.org</li>
                    <li class="list-group-item">landify.net</li>
                </ul>
            </div>
</div>

           <!-- Back Button (navigate to editor) -->
<!-- Container with flexbox to align buttons to the right -->
<div class="d-flex justify-content-end mt-3">
    <!-- Back Button (navigate to editor) -->
    <a href="/index" class="btn btn-outline-dark me-2">Back</a>

    <!-- Save Button (submit form) -->
    <a href="/marketing" class="btn btn-primary" style="background: #739AE8;">Save</a>
</div>
