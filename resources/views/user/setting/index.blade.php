...
<div class="content">
    ...
    <div class="card shadow-sm p-4">
        ...
        <div class="list-group">
            <a href="#seoSettings" data-bs-toggle="collapse" aria-expanded="false" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-3">
                    <img src="{{ asset('images/seo.png') }}" alt="SEO Settings" style="width: 30px; height: 30px;">
                    <div>
                        <h6 class="mb-0">SEO Settings</h6>
                        <small class="text-muted">Customize the default page settings and meta tags across all page types.</small>
                    </div>
                </div>
                <!-- Ganti Ikon Panah dengan Bootstrap Icon -->
                <img src="{{ asset('images/panah bawah.png') }}" alt="Chevron Down" style="width: 20px; height: 20px;">
            </a>
            <div id="seoSettings" class="collapse mt-3">
                <!-- Konten tambahan SEO Settings -->
                <div class="d-flex justify-content-between align-items-center p-3 border">
                    <img src="{{ asset('images/frame1.png') }}" alt="Site Preview" style="width: 100px; height: 70px;">
                    <div>
                    <span style="display: block; font-size: 14px; color: #6D6D6D; margin-bottom: 10px;">Site Name</span> 
                    <strong>Portfolio Fabulous Site</strong>
                </div>
                <div>
                    <span style="display: block; font-size: 14px; color: #6D6D6D; margin-bottom: 10px;">Site Address</span>
                    <strong>portfolio.com</strong>
                </div>
                    <a href="{{ route('user.setting.seo.index') }}" class="btn btn-primary" style="background: #739AE8;">Setup SEO <img src="{{ asset('images/panahsamping.png') }}" alt="Chevron Down" style="width: 20px; height: 20px;"></a>
                </div>
            </div>

            <a  class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-3">
                    <img src="{{ asset('images/marketing.png') }}" alt="Marketing Integration" style="width: 30px; height: 30px;">
                    <div>
                        <h6 class="mb-0">Marketing Integration</h6>
                        <small class="text-muted">Customize the default page settings and meta tags across all page types.</small>
                    </div>
                </div>
                <a href="#domainSetting" data-bs-toggle="collapse" aria-expanded="false" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
    <div class="d-flex align-items-center gap-3">
        <img src="{{ asset('images/domain.png') }}" alt="Domain Setting" style="width: 30px; height: 30px;">
        <div>
            <h6 class="mb-0">Domain Setting</h6>
            <small class="text-muted">Customize the default page settings and meta tags across all page types.</small>
        </div>
    </div>
    <!-- Ikon Panah -->
    <img src="{{ asset('images/panah bawah.png') }}" alt="Chevron Down" class="toggle-icon" style="width: 20px; height: 20px;">
</a>
<div id="domainSetting" class="collapse mt-3">
    <!-- Konten tambahan Domain Setting -->
    <div class="d-flex justify-content-between align-items-center p-3 border">
                    <img src="{{ asset('images/frame1.png') }}" alt="Site Preview" style="width: 100px; height: 70px;">
                    <div>
                    <span style="display: block; font-size: 14px; color: #6D6D6D; margin-bottom: 10px;">Site Name</span> 
                ...
                <div>
                    ...
                    <a href="{{ route('user.setting.domain.index') }}" class="btn btn-primary" style="background: #739AE8;">Setup Domain <img src="{{ asset('images/panahsamping.png') }}" alt="Chevron Down" style="width: 20px; height: 20px;"></a>
                </div>
            </div>
        </div>
    </div>
